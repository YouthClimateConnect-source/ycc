  ...
  return (
    <div className="overflow-hidden group p-1 bg-transparent flex flex-col h-full gap-1 md:gap-2 transition-all duration-300">
      ...
      <CardHeader className="space-y-1 p-1">
        {/* Published Date */}
        <div className="flex items-center gap-1.5 text-xs text-slate-600 font-semibold md:font-medium 
      ...
      <CardContent className="p-1 grow">
        {/* Summary */}
        <p className="text-slate-600 text-sm md:leading-relaxed line-clamp-3">
          {summary}
        </p>
      </CardContent>
